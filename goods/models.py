...
class Products(models.Model):
    ...
    vendorCode = models.CharField(
        max_length=20, unique=True, verbose_name="Артикул товара"
    )
    guarantee = models.CharField(max_length=30, null=True, verbose_name="Гарантия")
    category = models.ForeignKey(
        to=Subcategories, on_delete=models.CASCADE, verbose_name="Подкатегория"
    )

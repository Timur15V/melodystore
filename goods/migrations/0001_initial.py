# Generated by Django 4.2.11 on 2024-04-25 20:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vendorCode', models.CharField(max_length=20, unique=True, verbose_name='Артикул товара')),
                ('guarantee', models.CharField(max_length=30, null=True, verbose_name='Гарантия')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.subcategories', verbose_name='Подкатегория')),
            ],
            options={
